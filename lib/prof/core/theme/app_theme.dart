...
class AppTheme {
  ...
  static const Color primary = Color(0xFF5863F8);
  ...
  static ThemeData get lightTheme {
    return ThemeData(
      ...
      textTheme: GoogleFonts.interTextTheme().copyWith(
        displayLarge: GoogleFonts.inter(fontSize: 32, fontWeight: FontWeight.w700, letterSpacing: -0.64, color: onSurface),
        displayMedium: GoogleFonts.inter(fontSize: 28, fontWeight: FontWeight.w700, letterSpacing: -0.24, color: onSurface),
        displaySmall: GoogleFonts.inter(fontSize: 20, fontWeight: FontWeight.w700, color: onSurface),
        headlineLarge: GoogleFonts.inter(fontSize: 24, fontWeight: FontWeight.w700, color: onSurface),
        headlineMedium: GoogleFonts.inter(fontSize: 20, fontWeight: FontWeight.w700, color: onSurface),
        ...
        labelLarge: GoogleFonts.inter(fontSize: 14, fontWeight: FontWeight.w600, color: onPrimary),
        labelSmall: GoogleFonts.inter(fontSize: 12, fontWeight: FontWeight.w600, color: onSurfaceVariant),
      ),
    );
  }
}
